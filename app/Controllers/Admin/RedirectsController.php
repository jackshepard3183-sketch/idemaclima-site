...
final class RedirectsController
{
    ...
    public static function save(): void
    {
        ...
        if(str_starts_with($target,'/idemaclima/admin'))$errors[]='La destinazione non può essere un percorso amministrativo.';
        ...
        header('Location:/idemaclima/admin/redirects');exit;
    }
