...
final class CatAuthController
{
    ...
    public static function register(): void
    {
        ...
        $old=['first_name'=>trim((string)($_POST['first_name']??'')),'last_name'=>trim((string)($_POST['last_name']??'')),'company_name'=>trim((string)($_POST['company_name']??'')),'email'=>strtolower(trim((string)($_POST['email']??''))),'phone'=>trim((string)($_POST['phone']??''))];
