...
final class CatAuthController
{
    ...
    public static function register(): void
    {
        ...
        $old=['first_name'=>Validator::naturalText($_POST['first_name']??''),'last_name'=>Validator::naturalText($_POST['last_name']??''),'company_name'=>Validator::companyName($_POST['company_name']??''),'email'=>strtolower(trim((string)($_POST['email']??''))),'phone'=>trim((string)($_POST['phone']??''))];
