...
final class ContactController
{
    ...
    public static function submit(): void
    {
        ...
        $allowedSubjects=['INFORMAZIONI COMMERCIALI / OFFERTE','INFORMAZIONI TECNICHE / ASSISTENZA'];
        if(!in_array((string)($old['subject']??''),$allowedSubjects,true))$errors[]='Seleziona un oggetto valido.';
