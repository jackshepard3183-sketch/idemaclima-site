...
<div class="toolbar">
  ...
  <a class="btnlink" href="/admin/campus/registrations/export?<?=http_build_query(array_filter(['event_id'=>(int)($filters['event_id']??0),'status'=>(string)($filters['status']??'')]))?>">Esporta CSV / Excel</a>
</div>
...
<div class="table-wrap"><table><thead><tr><th>Evento</th><th>Partecipante</th><th>Contatti</th><th>Azienda</th><th>Stato</th><th>Presenza</th><th>Gestione</th></tr></thead><tbody>
