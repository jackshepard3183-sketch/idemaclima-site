...
<?php foreach($categories as $c): ?><tr><td><strong><?= htmlspecialchars($c['name'],ENT_QUOTES,'UTF-8') ?></strong></td><td><?= htmlspecialchars((string)($c['parent_name']??'Categoria principale'),ENT_QUOTES,'UTF-8') ?></td><td class="muted"><?= htmlspecialchars($c['slug'],ENT_QUOTES,'UTF-8') ?></td><td><?= (int)$c['sort_order'] ?></td><td><span class="badge"><?= htmlspecialchars(['draft'=>'Bozza','published'=>'Pubblicata','hidden'=>'Nascosta'][$c['content_status']??'']??($c['published']?'Pubblicata':'Nascosta'),ENT_QUOTES,'UTF-8') ?></span></td><td><a href="/admin/categories/form?id=<?= (int)$c['id'] ?>">Modifica</a></td></tr><?php endforeach; ?>
</tbody></table></div>
