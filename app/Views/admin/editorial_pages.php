...
<?php foreach($pages as $page): ?><tr><td><strong><?= htmlspecialchars((string)$page['title'],ENT_QUOTES,'UTF-8') ?></strong><br><span class="muted"><?= htmlspecialchars((string)$page['slug'],ENT_QUOTES,'UTF-8') ?></span></td><td><span class="badge <?= !empty($page['published'])?'badge-new':'' ?>"><?= !empty($page['published'])?'Pubblicato':'Nascosto' ?></span></td><td><?= (int)$page['sort_order'] ?></td><td><a class="btnlink" href="/admin/editorial/form?id=<?= (int)$page['id'] ?>">Modifica</a></td></tr><?php endforeach; ?>
</tbody></table></div>
