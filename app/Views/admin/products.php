...
<details class="product-group" open><summary><span><?= htmlspecialchars($group,ENT_QUOTES,'UTF-8') ?></span><span class="tree-count"><?= $groupCount ?> prodotti</span></summary>
