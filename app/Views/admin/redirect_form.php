...
<form class="panel formgrid" method="post" action="/admin/redirects/save"><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf,ENT_QUOTES,'UTF-8') ?>"><input type="hidden" name="id" value="<?= (int)$redirect['id'] ?>">
...
<div class="full"><button class="btn" type="submit">Salva redirect</button> <a href="/admin/redirects">Annulla</a></div></form>
