...
<div class="toolbar"><div><h1>Redirect SEO</h1><p class="muted">Gestisci i vecchi URL che devono inoltrare alle nuove pagine.</p></div><a class="btnlink" href="/idemaclima/admin/redirects/form">Nuovo redirect</a></div>
