...
<form class="panel" method="post" action="/admin/settings/<?= htmlspecialchars($group,ENT_QUOTES,'UTF-8') ?>/save"><input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf,ENT_QUOTES,'UTF-8') ?>"><div class="formgrid">
