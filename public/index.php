...
use App\Controllers\Admin\MonoSplitImportController;
...
$router->post('/admin/media/update', [MediaLibraryController::class, 'update']);
$router->post('/admin/media/replace', [MediaLibraryController::class, 'replace']);
$router->post('/admin/media/archive', [MediaLibraryController::class, 'archive']);
...
$router->get('/admin/campus/participants/detail', [AdminCampusController::class, 'participantDetail']);
$router->post('/admin/campus/participants/update', [AdminCampusController::class, 'updateParticipant']);
